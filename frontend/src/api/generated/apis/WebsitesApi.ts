...
export class WebsitesApi extends runtime.BaseAPI {
     ...
     * Add a domain to a website
     */
    async addDomainToWebsiteRaw(
        requestParameters: AddDomainToWebsiteOperationRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<FormResultForSingleUuidAndAddDomainToWebsiteForm>> {
        ...
        const response = await this.request(
            {
                path: `/api/frontend/v1/user/websites/{uuid}/domains`.replace(
                    `{${"uuid"}}`,
     ...
     * Add a domain to a website
     */
    async addDomainToWebsite(
        requestParameters: AddDomainToWebsiteOperationRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<FormResultForSingleUuidAndAddDomainToWebsiteForm> {
     ...
     */
    async checkDnsRaw(
        requestParameters: CheckDnsRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<SingleUuid>> {
        if (requestParameters["uuid"] == null) {
            throw new runtime.RequiredError(
                "uuid",
        ...
        const response = await this.request(
            {
                path: `/api/frontend/v1/user/websites/{uuid}/check-dns`.replace(
                    `{${"uuid"}}`,
                    encodeURIComponent(String(requestParameters["uuid"])),
                ),
                method: "POST",
     ...
     * Create a new website
     */
    async createWebsiteRaw(
        requestParameters: CreateWebsiteOperationRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<SingleUuid>> {
    ...
    async deleteWebsiteRaw(
        ...
        const response = await this.request(
            {
                path: `/api/frontend/v1/user/websites/{uuid}`.replace(
                    `{${"uuid"}}`,
                    encodeURIComponent(String(requestParameters["uuid"])),
                ),
                method: "DELETE",
     ...
     */
    async deployWebsiteRaw(
        requestParameters: DeployWebsiteRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<SingleUuid>> {
        if (requestParameters["uuid"] == null) {
            throw new runtime.RequiredError(
        ...
        const response = await this.request(
            {
                path: `/api/frontend/v1/user/websites/{uuid}/deploy`.replace(
                    `{${"uuid"}}`,
                    encodeURIComponent(String(requestParameters["uuid"])),
                ),
                method: "POST",
     ...
     * Retrieve all websites owned by this user
     */
    async getAllWebsitesRaw(
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<ListWebsites>> {
        const queryParameters: any = {};
     ...
     */
    async getWebsiteRaw(
        requestParameters: GetWebsiteRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<FullWebsite>> {
        if (requestParameters["uuid"] == null) {
            throw new runtime.RequiredError(
                "uuid",
     ...
     * Remove a domain from a website
     */
    async removeDomainFromWebsiteRaw(
        requestParameters: RemoveDomainFromWebsiteRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request(
            {
                path: `/api/frontend/v1/user/websites/{website_uuid}/domains/{domain_uuid}`
                    .replace(`{${"domain_uuid"}}`, encodeURIComponent(String(requestParameters["domain_uuid"])))
                    .replace(`{${"website_uuid"}}`, encodeURIComponent(String(requestParameters["website_uuid"]))),
                method: "DELETE",
                headers: headerParameters,
                query: queryParameters,
            },
     ...
     * Update a website
     */
    async updateWebsiteRaw(
        requestParameters: UpdateWebsiteOperationRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<void>> {
        if (requestParameters["uuid"] == null) {
            throw new runtime.RequiredError(
