...
export class UserInvitesApi extends runtime.BaseAPI {
    ...
    async createInviteRaw(
        requestParameters: CreateInviteRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<runtime.ApiResponse<FormResultForCreateUserInviteResponseAndCreateUserInviteErrors>> {
    ...
    async createInvite(
        requestParameters: CreateInviteRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ): Promise<FormResultForCreateUserInviteResponseAndCreateUserInviteErrors> {
